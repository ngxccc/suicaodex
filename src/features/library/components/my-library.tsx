...
import DetailsCard from "@/features/search/components/Result/details-card";
import {
  Alert,
  AlertDescription,
  AlertTitle,
...
import { getMangasByIDs } from "@/features/history/api/history";
import type { LibraryType } from "@/shared/types/common";
