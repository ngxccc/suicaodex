  ...
  return (
    <div className={cn("relative rounded border p-20", className)} {...props}>
      ...
      >
        ...
        {/* left side */}
        <div className="h-[100cqmax]th:100cqh] @container absolute top-0 left-0 origin-[0%_0%] transform-[rotate(90deg)_rotateX(-90deg)] bg-size-[var(--beam-size)_var(--beam-size)] [background:linear-gradient(var(--grid-color)_0_1px,transparent_1px_var(--beam-size))_50%_-0.5px_/var(--beam-size)_var(--beam-size),linear-gradient(90deg,var(--grid-color)_0_1px,transparent_1px_var(--beam-size))_50%_50%_/var(--beam-size)_var(--beam-size)] transform-3d">
